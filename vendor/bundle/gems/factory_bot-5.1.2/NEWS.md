...
## 4.9.0 (skipped - FactoryBot only release)
...
## 4.8.0 (December 16, 2016)
  ...
  * Add `FactoryBot.generate_list` to be consistent with `build_list`/`create_list` and friends
  * Add `FactoryBot.use_parent_strategy` configuration to allow associations to leverage parent build strategy
